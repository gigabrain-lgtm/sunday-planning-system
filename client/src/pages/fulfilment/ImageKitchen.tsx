    ...
    <Sidebar>
      <div className="min-h-screen bg-gray-950 p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="bg-gray-900 border-gray-800 hover:border-gray-700 transition-colors">
            ...
            <CardContent>
              ...
              <Button variant="outline" className="w-full bg-gray-800 border-gray-700 text-gray-400" disabled>
                Coming Soon
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-900 border-gray-800 hover:border-gray-700 transition-colors">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-white">Image Editing</CardTitle>
              </div>
              <CardDescription className="text-gray-400">
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader>
            <CardTitle className="text-white">About Image Kitchen</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-medium text-white">Features (Coming Soon):</h3>
            ...
            <div className="pt-4 border-t border-gray-800">
              <h3 className="font-medium mb-2 text-white">Migration Status</h3>
              <p className="text-sm text-gray-400">
